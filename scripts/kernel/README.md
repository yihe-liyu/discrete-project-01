...
- **autoload**：`GameState / StageManager / BulletManager / RNG / AudioManager / GameEvents / GameManager`（W1/W2/W3a 后：`LayerConfig`/`AssetRegistry` 改 class_name，`MissEffectManager`/`StageObjects`/`HitEffectPool` 改组合根注入）
